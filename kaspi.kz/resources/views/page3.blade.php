...
<body>
 ...
 <div class="bs-example">  
    <a class="navbar-brand" href="#">Магазин</a><div class="collapse navbar-collapse" id="navbar-main">
      ...
      <ul class="nav navbar-nav">
        <li class="active">
          <a href="#">СКИДКИ % <span class="sr-only">(current)</span></a>
           ...
           <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">ТЕЛЕФОНЫ И ГАДЖЕТЫ<span class="caret"></span></a>
...
<div class="row">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="https://kaspi.kz/medias/sys_master/images/images/h30/h4b/9057825521694/apple-macbook-12-a1534-mlhe2-gold-1303196-1.jpg" alt="Image" style="width:100%;">
        ...
        <div class="item">
          <img src="https://kaspi.kz/medias/sys_master/images/images/hfa/he3/9057826275358/apple-macbook-12-a1534-mlhe2-gold-1303196-4.jpg" alt="Image" style="width:100%;">
          <div class="carousel-caption">
  ...
  <div class="col-sm-4">
    <div class="about-dev">
      <h1>Ноутбук Apple MacBook 12 A1534 MLHE2 Gold</h1>
      <p>Intel Core m3 1100 MHz / 12" / 2304x1440 / 8.0Gb / 256Gb SSD / DVD нет / Intel HD Graphics / Wi-Fi / Bluetooth / Mac OS X</p>
    </div>
  </div>
</div>
<hr>
...
<div class="container text-center">    
  <h3>Вы недавно смотрели</h3><br>
  <div class="row">
    <div class="col-sm-4">
      <img src="img/9147142701086.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p><a href="">Apple Ipone 8</a></p>
    </div>
    <div class="col-sm-4"> 
     <img src="img/9147142701086.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p>Project 2</p>    
